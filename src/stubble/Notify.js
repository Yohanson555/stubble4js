...
module.exports = {
    NOTIFY_SECOND_OPEN_BRACKET_FOUND,
    NOTIFY_SECOND_CLOSE_BRACKET_FOUND,
    NOTIFY_IS_HELPER_SEQUENCE,
    NOTIFY_IS_BLOCK_SEQUENCE,
    NOTIFY_IS_DATA_SEQUENCE,
    NOTIFY_IS_BLOCK_HELPER_SEQUENCE,
    NOTIFY_IS_IF_BLOCK_SEQUENCE,
    NOTIFY_IS_EACH_BLOCK_SEQUENCE,
    NOTIFY_IS_WITH_SEQUENCE,
    NOTIFY_PATH_RESULT,
    NOTIFY_NAME_RESULT,
    NOTIFY_ATTR_RESULT,
    NOTIFY_BLOCK_END_RESULT,
    NOTIFY_CONDITION_RESULT,
};