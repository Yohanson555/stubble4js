...
exports.OpenBracketState = void 0;
    ...
    process(msg, context) {
        ...
        switch (charCode) {
            case chars.OPEN_BRACKET:
                res.pop = true;
                res.message = new StubbleMessages_1.NotifyMessage(notifies.NOTIFY_SECOND_OPEN_BRACKET_FOUND, charCode);
                break;
            default:
                res.err = new StubbleError_1.StubbleError(errors.ERROR_CHAR_NOT_A_OPEN_BRACKET, 'Wrong character is given. Expected "{"');
        }
        return res;
    }
}
exports.OpenBracketState = OpenBracketState;
//# sourceMappingURL=OpenBracketState.js.map