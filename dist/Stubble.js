...
exports.Stubble = void 0;
const lodash_1 = __importDefault(require("lodash"));
const StubbleContext_1 = require("./StubbleContext");
const StubbleMachine_1 = require("./StubbleMachine");
class Stubble {
    ...
    compile(template) {
        ...
        let machine = new StubbleMachine_1.StubbleMachine(template);
        return (data) => {
            let context = new StubbleContext_1.StubbleContext(data, this._helpers, this._options, (tpl) => this.compile(tpl));
    ...
    helperCount() {
        return this._helpers ? lodash_1.default.size(this._helpers) : 0;
    }
...
//# sourceMappingURL=Stubble.js.map